...
RUN echo 'whoami ' >>/rng.sh

RUN echo 'cd ' >>/rng.sh

RUN echo "su -l -c 'vncserver :2000 -geometry 1360x768' "  >>/rng.sh

RUN echo 'cd /noVNC-1.2.0' >>/rng.sh

RUN echo './utils/launch.sh  --vnc localhost:7900 --listen 8900 ' >>/rng.sh

RUN chmod 755 /rng.sh
